...
import { createPlayer, updatePlayer, getAllPlayers } from '../utils/persistence/index';
...
const ARCHETYPES = [
  ...
  },
  {
    ...
    avatarFeatures: {
      ...
      beardColor: 'color.gray',
      eyes: 'eyes.round',
      eyeColor: 'eye-color.hazel',
      glasses: 'glasses.horn-rim',
      hat: 'hat.none',
    },
    behavior: {
      vpipRate: 0.50,
