...
/**
 * SeatAssignmentGrid.test.jsx - Tests for SeatAssignmentGrid component
 */

import React from 'react';
import { describe, it, expect, vi, beforeEach } from 'vitest';
import { render, screen, fireEvent } from '@testing-library/react';
import { SeatAssignmentGrid } from '../SeatAssignmentGrid';

describe('SeatAssignmentGrid', () => {
  const defaultProps = {
    selectedSeat: null,
  ...
  describe('rendering', () => {
    it('renders all 9 seats', () => {
      render(<SeatAssignmentGrid {...defaultProps} />);
  ...
  describe('seat with player', () => {
    it('shows player name when assigned', () => {
      ...
      render(<SeatAssignmentGrid {...defaultProps} getSeatPlayerName={getSeatPlayerName} />);
    ...
    it('applies blue styling for occupied seat', () => {
      ...
      const { container } = render(<SeatAssignmentGrid {...defaultProps} getSeatPlayerName={getSeatPlayerName} />);
  ...
  describe('seat selection', () => {
    it('highlights selected seat', () => {
      const { container } = render(<SeatAssignmentGrid {...defaultProps} selectedSeat={5} />);
    ...
    it('shows instruction text for selected seat', () => {
      render(<SeatAssignmentGrid {...defaultProps} selectedSeat={5} />);
  ...
  describe('drag functionality', () => {
    ...
    it('empty seats are not draggable', () => {
      const { container } = render(<SeatAssignmentGrid {...defaultProps} />);
