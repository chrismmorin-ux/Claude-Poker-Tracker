...
export const RULES = [
  ...
  // ─── FLOP: as the aggressor ────────────────────────────────────────────────
  {
    ...
    shape: 'absolute', conditions: ['iAmLastPreflopAggressor', 'facing=no bet'],
  ...
  },
  {
    ...
    shape: 'conditional', conditions: ['iAmLastPreflopAggressor', 'boardTexture.connected', 'boardTexture.highCard'],
  ...
  },
  {
    ...
    shape: 'sizing', conditions: ['myBetOverPotBefore'],
  ...
  },
  {
    ...
    shape: 'sizing', conditions: ['myBetOverPotBefore', 'handClass'],
