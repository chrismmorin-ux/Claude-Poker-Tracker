...
> **Stake-caveat tightening (retroactive 2026-05-17 SPR-085 / WS-066).** The "25-35% bluff" LSW reference number is the solver/typical-stakes average per the upstream LSW A1 external-validation log (row 2 in `docs/design/audits/line-audits/btn-vs-bb-3bp-ip-wet-t96.md`). Live low-stakes pools polarize less (often 15-25% bluff); aggressive high-stakes pools polarize more (35-50%). The 73:27 target landed here was stake-conditioned to typical-stakes; the same rubric run at a different stake-stratum would produce a different "correct" ratio. Bucket-teaching consumers of this audit MUST inherit the stake-caveat.
