...
| 3 | "JTs has ~40%+ equity vs BB's 3bet range on T96ss" | manual combinatorial review vs typical BB 3bet range (JJ+, AK/AQs, KQs, A5s-A4s bluffs) | PokerListings equity conventions + mental weighted avg | 37–44% depending on fraction of A-high blocker bluffs in BB's range. ~40% is defensible; within rounding of solver-ish ranges. | **A-with-nuance** (equity-vs-subset: validated against the specific BB 3bet subset enumerated in the Query column; broader BB construction variants — wider lin/merged with KJs/QJs, or tighter polar — shift the band by ±3-5pp. Retroactive 2026-05-17 SPR-085 / WS-066 applying the A5-A8 forward discipline; original cat A unchanged in spirit but scope-bounded.) |
...
| 2 | "BB's polar bluff frequency on the river after a checked turn is 30-40%" | "3bet pot BB check-back river after turn checked through bluff frequency" | GTO Wizard "Mastering Turn Play in 3-Bet Pots OOP" + PokerCoaching articles | Checked-back turn = capped IP range → OOP river aggression at high frequency with polar range. Exact bluff frequency varies by board but 30–40% is in the right ballpark for a population/solver average in this line. | **A-with-stake-caveat** (30-40% is the solver/typical-stakes average; live low-stakes pools polarize less (often 15-25% bluff), aggressive high-stakes pools polarize more (35-50%). Bucket-teaching consumers MUST stake-condition this number rather than treat it as universal. Retroactive 2026-05-17 SPR-085 / WS-066 applying the A5-A8 forward discipline.) |
