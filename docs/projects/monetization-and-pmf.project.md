...
| 2026-04-27 (SHC routing-in) | **E-IGNITION evaluator first-impression sidebar-coherence concern routed in from SHC project** | SHC (Sidebar Holistic Coherence) Gate 2 outside-lens identified that E-IGNITION's first-impression coherence is a conversion-signal concern (15–30 min trial window) distinct from the training-cost concern that SHC otherwise covers. Owner adopted SHC Scope A 2026-04-27 — SHC scoped to fluent-user / training-cost only; E-IGNITION first-impression-coherence is **MPMF's territory**. MPMF retains optionality: when E-IGNITION trial-first-session work is scoped (Bundle ε / Phase 2+ Ignition SKU per Q3=C deferral), decide whether the future SHC shell spec serves as a first-impression-coherence contract or whether sidebar-specific evaluation work needs a separate audit. The proposed `personas/situational/trial-first-session-sidebar.md` (parent: Evaluator E-IGNITION sub-shape per `personas/core/evaluator.md` lines 100–106) is a Gate 3 / Gate 4 candidate **for MPMF**, not for SHC. Refs: `docs/design/audits/2026-04-27-blindspot-sidebar-holistic-coherence.md` Stage A5 + Overall verdict §Scope decision; doctrine v3 R-1.6/R-1.7 in `docs/SIDEBAR_DESIGN_PRINCIPLES.md`. |
