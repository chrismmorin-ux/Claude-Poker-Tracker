...
| 9 | [ ] | Hook Updates & Integration + Bootstrap Exception | 6 |
...
| T-P9-005 | Add bootstrap exception for decomposition-policy | `.claude/hooks/enforce-delegation.cjs` | Claude | [ ] |
| T-P9-006 | Integration test all hooks | N/A | Claude | [ ] |
