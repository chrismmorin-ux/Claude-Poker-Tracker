...
| RT-47 | P2 | NEXT | Sidebar: eliminate async/sync handler interleave in handlePipelineStatus | handlePipelineStatus either snapshots all state before await or re-reads after; test simulates concurrent push during await | — |
