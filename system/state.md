...
Last updated: 2026-05-16 (SPR-083 — postflop EV-bucket partition fix shipped; WS-185 closed; broader-scope 4-surface fix)
...
|------|--------|-------|--------|
| Tests | GREEN | `bash scripts/smart-test-runner.sh` | ~5,400+ app + 2,249 extension tests |
...
| 2026-05-13 | SPR-075 — Rules-correctness primitives (WS-182 + WS-183) | recordSeatAction collapse: CHECK-while-owing now structurally unrepresentable. Showdown winner card-edit hard-lock + unlock affordance. 22 new tests; 11056 tests pass. INV-RULES-CONTRIBUTION added. |
